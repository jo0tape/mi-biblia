...
export function Onboarding({ onFinish }: Props) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 1000, maxWidth: 430, margin: "0 auto", overflow: "hidden" }}>
      <div style={{ height: "100%", overflowY: "auto", WebkitOverflowScrolling: "touch" as any, background: C.bg }}>
